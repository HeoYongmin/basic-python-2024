...
class qtwin_exam(QWidget): # QWidget을 [상속]받을거야. QWidget이 가진 모든 것을 사용할 수 있다.
    # 생성자
    ...
    def initUI(self):
        self.setGeometry((1920 - 400)//2, (1080 - 300)//2, 400, 300) # x, y, width, height, -400, -300을 한이유는 정중앙에 위치하도록 하기 위해서
    ...
    def drawText(self, event, paint):
        ...
        paint.drawText(event.rect(), Qt.AlignLeft, self.text) # Alingn(정렬) - Left, Center. Right
...
loop = QApplication(sys.argv) # 내 소스의 위치로 앱을 생성할거야
