...
string_1 = '{}'.format(10) # {}위치에 함수 뒤에 들어있는 값(숫자든 문자든 상관없음)을 치환, 원하는 양식으로 표현 
print(type(string_1))

name = '허용민' #input('이름 입력 > ')
...
print(string_3)
# 정수를 문자열 포맷
#=: 기호와 숫자를 분리, 05: 다섯자리를 만들 때 빈자리를 0으로 채우기, d: 정수
string_4 = '_____{:05d}_____'.format(100)
print(string_4)
#실수 문자열 포맷f (기본 소수점6자리)
# 7.2f는 전체 자리수를 7자리로, 소수점 뒤는 2자리 fix
string_5 = '_____{:7.2f}______'.format(78.33333333)
print(string_5)
...
print(string_7.lower().capitalize()) # capitalize 첫번째 글자만 대문자로 변환

print(string_7.split(',')) # 특정한 단어로 자르는 함수

string_8 = 'Hello, I am YM Heo. I am a stydent. Good Luck for your day.'
