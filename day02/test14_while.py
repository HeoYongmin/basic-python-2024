...
# 무한루프 : Window OS, 보마일Os, 자동차 네비게이션, 라즈베리파이, 아두이노, 게임Winform개발, ...
while True: # 참인동안 True는 항상 참(Infinite Loop)
    count = count + 1
    print('나무찍기', count)
    if count == 10:
        break # 이 반복문을 빠져나가라!
# str은 괄호 안에 넣어준 값을 문자형 자료로 바꿔주는 기능
number = 0
while True:
    number = number + 1
